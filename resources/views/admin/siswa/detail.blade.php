...
<div class="container bg-white p-4 rounded shadow-sm">
    ...
    <div class="text-end mb-3">
        ...
        <a href="{{ url('admin/siswa/'.$siswa->id_siswa.'/edit') }}"
        class="btn btn-warning">
            Edit Data
        </a>

        <a href="{{ url('admin/export/buku-induk/'.$siswa->id_siswa) }}" class="btn btn-success">
            Download PDF
        </a>
        ...
        <div class="col-md-9">
            ...
            <table class="table table-borderless table-sm data-table">
                ...
                <tr>
                    ...
                    <td>: {{ $siswa->kelasAktif->kelas->nama_kelas ?? '-' }}</td>
                </tr>
    ...
    <div class="mt-3">
                <a href="{{ url('/admin/siswa') }}" class="btn btn-secondary btn-sm">
                    Kembali
                </a>
    </div>
