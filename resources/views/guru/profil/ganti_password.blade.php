...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ url('guru/profil/password') }}" method="POST">
            @csrf
            ...
            <a href="{{ url('guru/profil') }}" class="btn btn-secondary">Kembali</a>
        </form>
        ...
        <div class="mt-3">
            ...
            <form action="{{ url('guru/profil/reset-email') }}" method="POST"
