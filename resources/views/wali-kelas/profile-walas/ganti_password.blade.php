...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ url('wali/profil/password') }}" method="POST">
            @csrf
            ...
            <a href="{{ url('wali/profil') }}" class="btn btn-secondary">Kembali</a>
        </form>
        ...
        <div class="mt-3">
            ...
            <form action="{{ url('wali/profil/reset-email') }}" method="POST"
