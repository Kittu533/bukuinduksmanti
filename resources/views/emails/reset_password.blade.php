...
<head>
    ...
    <title>Reset Password Buku Induk</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 4px 16px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg, #2563eb 0%, #1e40af 100%); padding:32px 24px; text-align:center;">
                            ...
                            <p style="color:rgba(255,255,255,0.9); font-size:13px; margin:6px 0 0;">
                                Buku Induk SMA Negeri 3 Cilacap
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px 32px 8px;">
                            ...
                            <p style="font-size:14px; line-height:1.6; color:#4b5563; margin:0;">
                                Anda baru saja melakukan reset password akun Buku Induk. Berikut detail akun Anda dengan password baru:
                            </p>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:8px; padding:20px;">
                                ...
                                <tr>
                                    <td style="border-top:1px dashed #d1d5db; padding-top:12px;">
                                        ...
                                        <div style="font-size:18px; color:#dc2626; font-weight:700; font-family:'Courier New', monospace; letter-spacing:1.5px;">
                                            {{ $passwordBaru }}
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:14px 16px;">
                                        <p style="margin:0; font-size:13px; color:#78350f; line-height:1.6;">
                                            <strong>⚠️ Demi keamanan akun Anda</strong><br>
                                            Segera login dan ubah password ini melalui menu <strong>Profil → Ganti Password</strong>. Jangan bagikan password ini kepada siapa pun.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center" style="padding:8px 32px 32px;">
                            <a href="{{ $loginUrl }}"
                               style="display:inline-block; background:#2563eb; color:#ffffff; text-decoration:none; padding:14px 36px; border-radius:8px; font-size:15px; font-weight:600; box-shadow:0 2px 8px rgba(37,99,235,0.3);">
                                Login Sekarang →
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 32px 32px;">
                            <p style="font-size:13px; color:#6b7280; line-height:1.6; margin:0; padding-top:16px; border-top:1px solid #e5e7eb;">
                                ...
                                Jika Anda tidak meminta reset password, segera hubungi admin sekolah untuk mengamankan akun Anda.
                            </p>
                        </td>
                    </tr>
